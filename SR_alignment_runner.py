...
if __name__ == '__main__':
	...
	while True:
		...
		print(BWA_path+" mem "+ref_path+"GRCh37_"+read[:-4]+".fasta "+read.strip()+" > "+read[:-4]+".Bwamem.sam")
		os.system(BWA_path+" mem "+ref_path+"GRCh37_"+read[:-4]+".fasta "+read.strip()+" > "+read[:-4]+".Bwamem.sam &")

		print(BWA_path+" aln "+ref_path+"GRCh37_"+read[:-4]+".fasta "+read.strip()+" > "+read[:-4]+".Bwa.sai && "+BWA_path+" samse "+ref_path+"GRCh37_"+read[:-4]+".fasta "+read[:-4]+".Bwa.sai "+read.strip()+" > "+read[:-4]+".Bwa.sam ")
		os.system(BWA_path+" mem "+ref_path+"GRCh37_"+read[:-4]+".fasta "+read.strip()+" > "+read[:-4]+".Bwa.sam &")
